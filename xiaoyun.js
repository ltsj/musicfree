...
async function getMediaSource(musicItem, quality) {
    const res = (
        await axios_1.default.get(`https://m-api.ceseet.me/url/wy/${musicItem.songmid}/${qualityLevels[quality]}`)
    ).data;
    return {
...
module.exports = {
    ...
    srcUrl: "https://ghp.ci/https://raw.githubusercontent.com/ltsj/musicfree/master/xiaoyun.js",
